%runDistFromCellEdgeIF(data, varargin) runs CCP detection on a single channel dataset of fixed-cell
...
% Philippe Roudot 12/2017, adapted from FA.

function [edgeDistStats,det]=runDistFromCellEdgeIF(data, varargin)
...
rng('default');
processFramesIF(data_old, 'Overwrite', ip.Results.Overwrite,'validateMask',ip.Results.validateMask);
